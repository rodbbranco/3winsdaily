            ...
            <div className="w-full max-w-md">
                <div className="text-center mb-8 animate-fade-in">
                    <div className="flex items-center gap-4 justify-center">
                        <div
                            className="items-center justify-center w-16 h-16 bg-gradient-warm rounded-2xl mb-4 shadow-glow">
                            {/*<Sparkles className="w-8 h-8 text-white" />*/}
                            <img src="/logo_white.png" alt="logo" className="w-16 h-16"/>
                        </div>
                    ...
                    {!isLogin && (
                        <div className="mt-8 space-y-3">
                            ...
                            <div className="grid gap-2">
                                ...
                                <div className="flex items-center gap-2 text-sm">
                                    <div
                                        className="w-8 h-8 rounded-lg bg-personal/10 flex items-center justify-center">
                                ...
                                <div className="flex items-center gap-2 text-sm">
                                    <div
                                        className="w-8 h-8 rounded-lg bg-growth/10 flex items-center justify-center">
